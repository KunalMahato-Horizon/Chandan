    ...
    <section ref={containerRef} className="bg-[#050505] relative overflow-hidden py-32 lg:py-48">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 items-start">
            ...
            >
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-mono text-zinc-300">BCA Student</span>
                </div>
          ...
          <div className="space-y-24 lg:pt-40">
            ...
            >
              {/* Sample Image - Replace with Chandan's actual photo */}
              <motion.img 
                style={{ y: imageY }}
              ...
              <div className="absolute top-6 left-6 bg-black/60 backdrop-blur-sm px-4 py-2 rounded-full border border-white/10">
                <span className="text-[10px] font-mono uppercase tracking-widest text-blue-400">Chandan Singh • Editor</span>
              </div>
              ...
              <div className="absolute bottom-6 right-6 bg-black/60 backdrop-blur-sm px-4 py-2 rounded-full border border-white/10">
                <span className="text-[10px] font-mono uppercase tracking-widest text-amber-400 flex items-center gap-1">
                  <Sparkles size={10} /> 1 Year Experience
                </span>
              </div>
            </motion.div>
            ...
            <div className="space-y-16">
              ...
              >
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-blue-500 font-mono text-xs tracking-[0.3em] uppercase">Let's Create</span>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative group">
                    ...
                    >
                      ...
                      <span>chandan@visualarchitect.com</span>
              ...
              >
                ...
                <span className="text-xs font-mono text-zinc-300">BCA Student • Video Editor • Creator</span>
              </motion.div>
            </div>
          </div>
        </div>
      ...
      >
        <div className="bg-black/40 backdrop-blur-md border border-white/10 px-4 py-2 rounded-full">
          <span className="text-[10px] font-mono uppercase tracking-widest text-blue-400">Based in India • Open to Work</span>
        </div>
      </motion.div>
